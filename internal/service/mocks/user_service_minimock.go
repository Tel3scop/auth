...
//go:generate minimock -i github.com/Tel3scop/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, dto model.User) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, dto}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, dto model.User)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, dto model.User) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, dto model.User) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserServiceMockCreateParams{ctx, dto},
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, dto model.User) (i1 int64, err error) {
	...
	mm_params := UserServiceMockCreateParams{ctx, dto}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, dto}
	...
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v", ctx, dto)
	return
}
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, userID int64, data model.UpdatingUserData) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, userID, data}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, userID int64, data model.UpdatingUserData)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Return(i1 int64, err error) *UserServiceMock {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.results = &UserServiceMockUpdateResults{i1, err}
	return mmUpdate.mock
}

// Set uses given function f to mock the UserService.Update method
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, userID int64, data model.UpdatingUserData) (i1 int64, err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, userID int64, data model.UpdatingUserData) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, userID, data},
	}
...
func (e *UserServiceMockUpdateExpectation) Then(i1 int64, err error) *UserServiceMock {
	e.results = &UserServiceMockUpdateResults{i1, err}
	return e.mock
}

// Update implements service.UserService
func (mmUpdate *UserServiceMock) Update(ctx context.Context, userID int64, data model.UpdatingUserData) (i1 int64, err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, userID, data}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, userID, data}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v %v", ctx, userID, data)
	return
}
