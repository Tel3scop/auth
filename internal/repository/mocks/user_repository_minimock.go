...
//go:generate minimock -i github.com/Tel3scop/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, dto model.User) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, dto model.User)
	...
	funcUpdate          func(ctx context.Context, userID int64, data model.UpdatingUserData) (i1 int64, err error)
	inspectFuncUpdate   func(ctx context.Context, userID int64, data model.UpdatingUserData)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, dto model.User) *mUserRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserRepositoryMockCreateParams{ctx, dto}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, dto model.User)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, dto model.User) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, dto model.User) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserRepositoryMockCreateParams{ctx, dto},
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, dto model.User) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateParams{ctx, dto}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateParams{ctx, dto}
	...
	mmCreate.t.Fatalf("Unexpected call to UserRepositoryMock.Create. %v %v", ctx, dto)
	return
}
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, userID int64, data model.UpdatingUserData) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, userID, data}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, userID int64, data model.UpdatingUserData)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Return(i1 int64, err error) *UserRepositoryMock {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.results = &UserRepositoryMockUpdateResults{i1, err}
	return mmUpdate.mock
}

// Set uses given function f to mock the UserRepository.Update method
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, userID int64, data model.UpdatingUserData) (i1 int64, err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, userID int64, data model.UpdatingUserData) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserRepositoryMockUpdateParams{ctx, userID, data},
	}
...
func (e *UserRepositoryMockUpdateExpectation) Then(i1 int64, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockUpdateResults{i1, err}
	return e.mock
}

// Update implements repository.UserRepository
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, userID int64, data model.UpdatingUserData) (i1 int64, err error) {
	mm_atomic.AddUint64(&mmUpdate.beforeUpdateCounter, 1)
	defer mm_atomic.AddUint64(&mmUpdate.afterUpdateCounter, 1)

	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, userID, data)
	}

	mm_params := UserRepositoryMockUpdateParams{ctx, userID, data}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, userID, data}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, userID, data)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v %v", ctx, userID, data)
	return
}
