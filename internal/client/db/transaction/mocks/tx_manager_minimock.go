...
//go:generate minimock -i github.com/Tel3scop/auth/internal/client/db/transaction.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
// TxManagerMock implements transaction.TxManager
type TxManagerMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcReadCommitted          func(ctx context.Context, f db.Handler) (err error)
	inspectFuncReadCommitted   func(ctx context.Context, f db.Handler)
	afterReadCommittedCounter  uint64
	beforeReadCommittedCounter uint64
	ReadCommittedMock          mTxManagerMockReadCommitted
}

// NewTxManagerMock returns a mock for transaction.TxManager
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Expect(ctx context.Context, f db.Handler) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Inspect(f func(ctx context.Context, f db.Handler)) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Set(f func(ctx context.Context, f db.Handler) (err error)) *TxManagerMock {
	if mmReadCommitted.defaultExpectation != nil {
...
// Then helper
func (mmReadCommitted *mTxManagerMockReadCommitted) When(ctx context.Context, f db.Handler) *TxManagerMockReadCommittedExpectation {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
...
// ReadCommitted implements transaction.TxManager
func (mmReadCommitted *TxManagerMock) ReadCommitted(ctx context.Context, f db.Handler) (err error) {
